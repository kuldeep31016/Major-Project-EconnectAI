...
def test_gmw_tile_names_cover_bbox():
    ...
    assert gmw_tile_names(aoi) == ["N09E076"]
    aoi2 = AOI("x", (21.80, 88.60, 22.10, 88.90))          # crosses the 22N parallel
    assert gmw_tile_names(aoi2) == ["N21E088", "N22E088"]
    aoi3 = AOI("s", (-1.5, -60.5, -0.5, -59.5))
    assert gmw_tile_names(aoi3) == ["S02W061", "S02W060", "S01W061", "S01W060"]
